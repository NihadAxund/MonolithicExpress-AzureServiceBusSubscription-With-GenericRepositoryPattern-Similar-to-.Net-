...
export class ManagementClient extends LinkEntity {
    ...
    async _makeManagementRequest(request, internalLogger, sendRequestOptions = {}) {
        ...
        try {
            ...
            await waitForSendable(internalLogger, this.logPrefix, this.name, timeoutInMs ?? Constants.defaultOperationTimeoutInMs, this.link?.sender, this.link?.session?.outgoing?.available());
