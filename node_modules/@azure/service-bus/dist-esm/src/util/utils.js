 ...
 */
export function ensureValidIdentifier(prefix, identifier) {
 ...
 */
export function reorderLockToken(lockTokenBytes) {
 ...
 */
export function calculateRenewAfterDuration(lockedUntilUtc) {
    const now = Date.now();
 ...
 */
export function convertTicksToDate(buf) {
 ...
 * or throws error if undefined.
 */
export function getBoolean(value, nameOfProperty) {
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
export function getBooleanOrUndefined(value) {
    if (!isDefined(value)) {
        return undefined;
    }
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
export function getMessageCountDetails(value) {
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
export function getXMLNSPrefix(value) {
 ...
 */
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
export function getAuthorizationRulesOrUndefined(value) {
 ...
 * or undefined if not passed in.
 */
export function getRawAuthorizationRules(authorizationRules) {
 ...
 * @internal
 */
export async function waitForTimeoutOrAbortOrResolve(args) {
 ...
 */
export const libInfo = `azsdk-js-azureservicebus/${Constants.packageJsonInfo.version}`;
/**
 * @internal
 * Returns the formatted prefix by removing the spaces, by appending the libInfo.
 */
export function formatUserAgentPrefix(prefix) {
 ...
 */
export const getHttpResponseOnly = (pipelineResponse) => toHttpResponse(pipelineResponse);
/**
 * @internal
