 ...
 *
 */
export function buildInternalRuleResource(rule) {
    const resource = {
        Filter: {},
        Action: {},
        Name: rule.name,
 ...
 * @internal
 */
export function isSqlRuleAction(action) {
 ...
 * or undefined if not passed in.
 */
export function buildInternalRawKeyValuePairs(parameters, attribute) {
